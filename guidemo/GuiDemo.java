...
public class GuiDemo extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        frame.setIconImage(new ImageIcon(Objects
                .requireNonNull(GuiDemo.class
                        .getClassLoader()
                        .getResource("resources/icons/frameIcon.png"))).getImage());
        //frame.setIconImage(new ImageIcon("resources/icons/frameIcon.png").getImage());
        //frame.setIconImage( Util.getImageResource("resources/icons/frameIcon.png"));
    ...
    public GuiDemo() {
        ...
        drawPanel.getTextItem().setText("""
                When I wrote this code,\s
                 only God and I understood what I did.\s
                 Now only God knows.""");
        ...
        drawPanel.setBackgroundImage(Util.getImageResource("resources/images/zero.jpeg"));
        ...
        content.add(makeToolbar(false), BorderLayout.NORTH);
        ...
        menuBar.add(iconSupport.makeStamperMenu());
        setJMenuBar(menuBar);
    ...
    /**
     * Create the Northern toolbar from actions that are defined in ChooseBackgroundAction class.
     */

    private JToolBar makeToolbar(boolean vertical) {

        JToolBar toolBar = new JToolBar(vertical ? JToolBar.VERTICAL : JToolBar.HORIZONTAL);

        toolBar.add(newPictureAction);
        toolBar.add(saveImageAction);
        toolBar.addSeparator();
        toolBar.add(new ChooseBackgroundAction("zero"));
    ...
    private JMenu makeBackgroundMenu() {
        ...
        menu.add(new ChooseBackgroundAction("zero"));
        ...
        gradientOverlayCheckbox.addActionListener(evt -> {
    ...
    public void setDefault() {
        ...
        gradientOverlayCheckbox.setSelected(false);
    }
    /**
        ...
        ChooseBackgroundAction(String text) {
            ...
            switch (text) {
                case "Color..." -> {
                    ...
                    int p = colorImage.getWidth() / 3;

                    Graphics2D g2d = colorImage.createGraphics();
                    g2d.setColor(Color.green);
                    g2d.fillRect(0, 0, p, colorImage.getHeight());
                    g2d.setColor(Color.yellow);
                    g2d.fillRect(p, 0, p, colorImage.getHeight());
                    g2d.setColor(Color.red);
                    g2d.fillRect(p * 2, 0, p * 3, colorImage.getHeight());
                    g2d.dispose();

                    putValue(Action.SMALL_ICON, new ImageIcon(colorImage));
...
////                    Graphics2D g2d = colorImage.createGraphics();
////
////                    g2d.setColor(new Color(35, 43, 43));
////                    g2d.fillRect(0, 0, colorImage.getWidth(), colorImage.getHeight());
////
////                    putValue(Action.SMALL_ICON, new ImageIcon(colorImage));
//                    putValue(Action.SMALL_ICON,
//                            Util.iconFromResource("resources/images/" + text.toLowerCase() + ".jpeg"));
//                    putValue(Action.SHORT_DESCRIPTION, "<html>Select an image file<br>to use as the background.</html>");
                ...
                default -> putValue(Action.SHORT_DESCRIPTION, "Use this image as the background.");
            }
